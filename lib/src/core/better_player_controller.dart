...
class BetterPlayerController {
  ...
  ///Set playback speed of video. Allows to set speed value between 0 and 10.
  Future<void> setSpeed(double speed) async {
    if (speed <= 0 || speed > 10) {
      BetterPlayerUtils.log("Speed must be between 0 and 10");
      throw ArgumentError("Speed must be between 0 and 10");
    }
    if (videoPlayerController == null) {
      BetterPlayerUtils.log("The data source has not been initialized");
      throw StateError("The data source has not been initialized");
